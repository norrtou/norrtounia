...
const GAME_DATA = {
    ...
    races: [
        {
            name:'High Elf', icon:'🧝', hp:45, str:8, int:18, dex:14, cha:14, sta:10, lck:10,
        ...
        {
            name:'Wood Elf', icon:'🏹', hp:50, str:11, int:14, dex:16, cha:12, sta:11, lck:11,
        ...
        {
            name:'Mountain Dwarf', icon:'⛏️', hp:80, str:17, int:7, dex:5, cha:7, sta:17, lck:8,
        ...
        {
            name:'Hill Dwarf', icon:'🛡️', hp:70, str:15, int:10, dex:7, cha:8, sta:15, lck:9,
        ...
        {
            name:'Orc', icon:'💢', hp:95, str:20, int:4, dex:6, cha:5, sta:16, lck:7,
        ...
        {
            name:'Half-Orc', icon:'⚔️', hp:75, str:18, int:8, dex:8, cha:7, sta:14, lck:8,
        ...
        {
            name:'Human', icon:'🗡️', hp:65, str:13, int:13, dex:11, cha:12, sta:12, lck:11,
            resistances:{},
        ...
        {
            name:'Halfling', icon:'🍀', hp:55, str:9, int:15, dex:15, cha:14, sta:10, lck:16,
        ...
        {
            name:'Gnome', icon:'🔮', hp:48, str:7, int:19, dex:13, cha:12, sta:9, lck:13,
        ...
        {
            name:'Tiefling', icon:'😈', hp:58, str:12, int:16, dex:12, cha:13, sta:12, lck:9,
    ...
    monsters: [
        ...
        { name:'Forest Wraith',     icon:'👻', hp: 55, str:12,  loot:0.35, xpValue: 50, undead:true, taunts:['A cold whisper: "Join us..."','The air temperature droppeth sharply.'] },
        { name:'Cave Bat Swarm',    icon:'🦇', hp: 20, str: 5,  loot:0.10, xpValue: 25 },
        { name:'Shadow Stalker',    icon:'🌑', hp: 60, str:14,  loot:0.30, xpValue: 55, taunts:['It moveth without sound.'] },
        { name:'Twisted Ent',       icon:'🌳', hp: 85, str:11,  loot:0.45, xpValue: 50, taunts:['The trees... move.'] },
        { name:'Skeleton Sentry',   icon:'💀', hp: 35, str: 9,  loot:0.20, xpValue: 35, undead:true, taunts:['Bones rattle in the silence.'] },
        { name:'Poisonous Adder',   icon:'🐍', hp: 25, str:15,  loot:0.15, xpValue: 45 },
        { name:'Grave Ghoul',       icon:'💀', hp: 55, str:13,  loot:0.40, xpValue: 50, undead:true, taunts:['It sniffs the air... hungrily.'] },
        { name:'Goblin Pack',       icon:'👺', hp: 30, str: 7,  loot:0.25, xpValue: 30, taunts:['\'Give us your shinies!\''] },
        { name:'Bog Hag',           icon:'🧙', hp: 50, str:16,  loot:0.50, xpValue: 60, boon:{int:3}, taunts:['\'Pretty travellers... come closer.\''] },
        { name:'Stone Gargoyle',    icon:'🗿', hp: 70, str:14,  loot:0.35, xpValue: 55 },
        { name:'Bandit Swordsman',  icon:'🗡️', hp: 50, str:13,  loot:0.40, xpValue: 50, taunts:['\'Your gold or your life, pilgrim.\''] },
        ...
        { name:'Hobgoblin Captain', icon:'👺', hp: 90, str:18,  loot:0.60, xpValue: 85, taunts:['\'Soldiers! To me!\''] },
        { name:'Werewolf',          icon:'🐺', hp:100, str:22,  loot:0.55, xpValue: 95, taunts:['It standeth on two legs... then four.'] },
        ...
        { name:'Bone Colossus',     icon:'💀', hp:110, str:24,  loot:0.70, xpValue:105, undead:true },
        { name:'Cursed Paladin',    icon:'⚔️', hp: 95, str:21,  loot:0.65, xpValue: 95, boon:{hp:15} },
        { name:'Forest Troll',      icon:'👹', hp: 90, str:19,  loot:0.55, xpValue: 88, taunts:['\'TROLL HUNGRY.\''] },
        { name:'Mountain Troll',    icon:'👹', hp:130, str:28,  loot:0.80, xpValue:135 },
        { name:'Ancient Wyvern',    icon:'🐉', hp:155, str:34,  loot:0.90, xpValue:160, taunts:['A shadow vast as a house descendeth.'] },
        { name:'Necromancer Lord',  icon:'🧙', hp:110, str:38,  loot:0.75, xpValue:150, boon:{int:6}, taunts:['\'Death is but a door, and I hold the key.\''] },
        { name:'Chaos Knight',      icon:'⚔️', hp:140, str:30,  loot:0.70, xpValue:140 },
        { name:'Lich of the Void',  icon:'💀', hp:170, str:42,  loot:0.85, xpValue:190, undead:true, boon:{int:8} },
        { name:'Elder Dragon',      icon:'🐉', hp:200, str:45,  loot:0.95, xpValue:200, taunts:['\'Curious. A morsel that walketh upright.\''] },
        { name:'The Great Honk of Death', icon:'🪿', hp:9999, str:999, loot:1.0, xpValue:500, special:'honk', spriteIdx:29 },
    ],
