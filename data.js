...
const GAME_DATA = {
    ...
    scenarios: [
        ...
        { text:'A mirror stands freestanding in the wood. Thine reflection moveth differently.',
          options:[{text:'Smash the mirror',type:'bad',effect:'Seven years of misfortune beginth.',damage:20,xp:10,morality:-5},{text:'Speak to the reflection',type:'good',effect:'It whispereth forgotten lore.',bonus:{int:8},xp:42,morality:0},{text:'Drape it with a cloak',type:'neutral',effect:'Out of sight, out of mind.',xp:8,morality:0}],
