...
const DAMAGE_TYPES = {
    ...
    fire:     { color:'#ff7733', label:'fire',       alignment:'dark'    },
    lightning:{ color:'#ffe033', label:'lightning',  alignment:'neutral' },
    frost:    { color:'#88eeff', label:'frost',      alignment:'neutral' },
    poison:   { color:'#6abf45', label:'poison',     alignment:'dark'    },
    nature:   { color:'#5caa30', label:'nature',     alignment:'light'   },
    shadow:   { color:'#b47afe', label:'shadow',     alignment:'dark'    },
    necrotic: { color:'#cc44ff', label:'necrotic',   alignment:'dark'    },
    void:     { color:'#7755dd', label:'void',       alignment:'dark'    },
    holy:     { color:'#ffd700', label:'holy',       alignment:'light'   },
    arcane:   { color:'#5bc8fa', label:'arcane',     alignment:'neutral' },
    psychic:  { color:'#e879f9', label:'psychic',    alignment:'neutral' },
    blood:    { color:'#cc2222', label:'blood',      alignment:'dark'    },
};
...
const GAME_DATA = {
    ...
    classes: [
        ...
        { name:'Necromancer', lore:'The line between life and death is not a wall — it is a door. Necromancers hold the key and charge admission. The dead find this arrangement agreeable.',  hpB:-5,  strB:-1, intB:15, dexB:0,  chaB:-1, staB:0,  lckB:0,  leadership:7,  moralityStart:-20, primaryStat:'int', damageType:'necrotic',  attackNames:['Death Bolt','Soul Drain','Bone Spear','Bone Curse','Grave Chill'],                   abilities:[{id:'undead_barrier',name:'Undead Barrier', desc:'Absorb the next monster hit entirely',         cooldown:4},{id:'wither',       name:'Wither',         desc:'−30% monster attack + 1.5× necrotic hit',     cooldown:3}] },
    ...
    scenarios: [
        ...
        { text:'A bridge of brittle bone spans a chasm of roaring fire.',
          options:[{text:'Cross with all speed',type:'bad',effect:'The bone snaps! Thou art scorched.',damage:22,xp:18,morality:0},{text:'Perform a rite of passage',type:'good',effect:'Wisdom guides thy steps safely.',bonus:{int:5},xp:35,morality:3},{text:'Seek a ford downstream',type:'neutral',effect:'Thou losest time but keep thy skin.',xp:10,morality:0}],
        ...
        { text:'A crumbling tower looms above the canopy. Runes of power glow upon its door.',
          options:[{text:'Force the door open',type:'bad',effect:'A ward explodes! Arcane fire scorcheth thee.',damage:35,xp:15,morality:-5},{text:'Read the runes aloud',type:'good',effect:'The tower yields its secrets.',item:true,bonus:{int:3},xp:40,morality:5},{text:'Leave well alone',type:'neutral',effect:'Some doors are not meant to be opened.',xp:8,morality:3}],
        ...
        { text:'A rusted iron chest lies half-buried in the earth.',
          options:[{text:'Pry the lid open',type:'good',effect:'A trapped pixie! She grants thee a boon.',item:true,xp:35,morality:10},{text:'Smash it with a weapon',type:'bad',effect:'A glyph of warding detonates! The heedless blow harms whatever was within.',damage:30,xp:12,morality:-5},{text:'Leave it buried',type:'neutral',effect:'Whatever lurks inside shall stay buried.',xp:8,morality:0}],
        ...
        { text:'Voices echo from a cave — familiar voices thou canst not place.',
          options:[{text:'Call out and enter',type:'bad',effect:'An illusion lured thee! Thou art ambushed.',damage:25,xp:12,morality:3},{text:'Throw a stone in first',type:'good',effect:'Startled bats reveal a hidden cache.',item:true,xp:32,morality:0},{text:'Seal the cave mouth',type:'neutral',effect:'Silence returns. Whatever was inside stays inside.',xp:8,morality:-8}],
        ...
        { text:'A dying knight clutches a sealed letter marked with royal wax.',
          options:[{text:'Read the letter',type:'good',effect:'Intelligence of enemy positions!',bonus:{int:6},xp:38,morality:5},{text:'Take the knight\'s sword',type:'good',effect:'A fine blade — but thou left him to die without a word.',item:true,xp:32,morality:-5},{text:'Give last rites and move on',type:'neutral',effect:'Thou honourest the fallen.',xp:15,morality:10}],
        ...
        { text:'A mirror stands freestanding in the wood. Thine reflection moveth differently.',
          options:[{text:'Smash the mirror',type:'bad',effect:'Seven years of misfortune beginth.',damage:20,xp:10,morality:-5},{text:'Speak to the reflection',type:'good',effect:'It whispereth forgotten lore.',bonus:{int:8},xp:42,morality:5},{text:'Drape it with a cloak',type:'neutral',effect:'Out of sight, out of mind.',xp:8,morality:0}],
        ...
        { text:'Rain begins. Beneath a hollow oak thou findest crude shelter and a fire already lit.',
          options:[{text:'Rest by the fire',type:'good',effect:'Warmth restores thy vitality.',bonus:{hp:25},xp:28,morality:0},{text:'Search the hollow',type:'good',effect:'A hermit\'s stash! Somebody shall miss this.',item:true,xp:32,morality:-3},{text:'Sleep in the rain',type:'bad',effect:'Hypothermia bites deep.',damage:15,xp:10,morality:0}],
        ...
        { text:'A vast spider-web blocks the path. Something large shifteth at its centre.',
          options:[{text:'Charge through',type:'bad',effect:'The spider descends! Thou art bitten.',damage:32,xp:12,morality:0},{text:'Burn the web',type:'good',effect:'The spider flees, leaving egg-sac treasure.',item:true,xp:35,morality:-3},{text:'Find a way around',type:'neutral',effect:'An hour detour keeps thee unbitten.',xp:10,morality:5}],
        ...
        { text:'A child stands alone on a stump, singing a tuneless song.',
          options:[{text:'Approach and speak',type:'bad',effect:'It is a changeling. Its touch rotteth.',damage:28,xp:8,morality:3},{text:'Leave an offering',type:'good',effect:'The fey child gifts thee a blessing.',bonus:{str:4,int:4},xp:40,morality:10},{text:'Ignore the child',type:'neutral',effect:'The singing fadeth as thou walkest on.',xp:8,morality:-5}],
        ...
        { text:'A grove of glowing mushrooms lines the path. They pulse with an inner purple light.',
          options:[{text:'Eat a handful',type:'bad',effect:'Hallucinations overwhelm thy senses!',damage:20,xp:15,morality:0},{text:'Harvest them carefully',type:'good',effect:'An alchemist\'s treasure.',bonus:{hp:20},item:true,xp:35,morality:3},{text:'Admire from a distance',type:'neutral',effect:'Their light guides thee safely.',xp:10,morality:5}],
        ...
        { text:'An enchanted music box sits open on a mossy stone, playing a haunting melody.',
          options:[{text:'Wind it further and listen',type:'good',effect:'Thy fellowship is soothed and healed.',bonus:{hp:20,cha:2},xp:35,morality:5},{text:'Smash it',type:'bad',effect:'The melody becomes a scream!',damage:22,xp:8,morality:-8},{text:'Take it with thee',type:'neutral',effect:'The tune followeth thee for days — the stone remembers what thou took.',item:true,xp:20,morality:-3}] },
        ...
        { text:'A locked chest hangs from a tree. A note reads: "Honesty opens all locks."',
          options:[{text:'Confess thy greatest failing',type:'good',effect:'The lock clicks open.',item:true,xp:45,morality:15},{text:'Lie loudly and try to pick it',type:'bad',effect:'The chain shocks thee.',damage:20,xp:10,morality:-5},{text:'Cut the tree down',type:'neutral',effect:'The chest falls but is already empty. The ancient oak crashes needlessly.',xp:8,morality:-5}] },
    ],
